            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-[#A5ACAF] mb-6">
                  Mark your calendar for Small Business Saturday on November 30, 2025. It&apos;s a day dedicated to supporting local businesses that create jobs, boost the economy, and preserve neighborhoods across the country.
                </p>
